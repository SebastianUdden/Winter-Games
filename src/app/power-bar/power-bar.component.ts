...
export class PowerBarComponent implements OnInit {
  ...
  private baseRandomNumberSpread = 50; // 50 is default
  ...
  extraTime(bonus) {
      ...
      this.randomNumberSpread = this.baseRandomNumberSpread + 36;
      ...
      if (this.totalBonusTime >= 60 && this.totalBonusTime < 80) {
          ...
          this.randomNumberSpread = this.baseRandomNumberSpread + 76;
      }
      if (this.totalBonusTime >= 80 && this.totalBonusTime < 100) {
          ...
          this.randomNumberSpread = this.baseRandomNumberSpread + 106;
      }
      if (this.totalBonusTime >= 100 && this.totalBonusTime < 120) {
          ...
          this.randomNumberSpread = this.baseRandomNumberSpread + 148;
      }
      if (this.totalBonusTime >= 120 && this.totalBonusTime < 140) {
          ...
          this.randomNumberSpread = this.baseRandomNumberSpread + 178;
      }
